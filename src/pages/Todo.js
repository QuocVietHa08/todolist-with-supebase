...
const Todos = () => {
  ...
  // useEffect to re-render the selectodo function will run one time if when the component rung
  useEffect(() => {
    selectTodos();
  }, []);
  return (
    <div className='Todo-card'>
      <nav>
        <button
          style={{ height: '2rem', pading: '0.2rem 1rem' }}
  ...
  return (
    <form className='Input-container'>
      ...
      <button
        ...
        Add{' '}
        <IoMdAddCircleOutline size={20} style={{ verticalAlign: 'middle' }} />
      </button>
    </form>
  );
};
